            ...
            <div class="col-md-6 mb-3">
                <div class="card" style="width: 950px;"> 
                    ...
                    <div class="card-body" style="background-color: #F6F5F5;">
                        <form action="{{ route('konselor.store.hasilkonseling') }}" method="post" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                            <div class="row mb-2">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="nim" id="nim" class="form-control" required oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                </div>
                                <div class="col-md-3">
                                    <label class="mb-1">No HP :</label><br>
                                    <input type="text" name="no_hp" id="no_hp" class="form-control" required oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                </div>
                    ...
                    <div class="card-body" style="background-color: #F6F5F5;">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="diagnosa" id="diagnosa" class="form-control mb-2" required>

                                    <label class="mb-1">Deskripsi :</label><br>
                                    <textarea name="deskripsi" id="deskripsi" class="form-control mb-2" rows="5" required></textarea>
                                </div>
                                <div class="col-md-6">
                                    <label class="mb-1">Tanggal Konseling :</label><br>
                                    <input type="date" name="tanggal_konseling" id="tanggal_konseling" class="form-control mb-2" required>
                                    ...
                                    <textarea type="text" name="rekomendasi" id="rekomendasi" class="form-control mb-2" rows="3" required></textarea>
                                    
                                </div>
                            </div>
                            <input type="submit" value="Save" class="btn mt-2" style="background-color: #00B9AD; color: #FFFFFF;">
                            <a href="{{ url('/konselor/hasilKonseling') }}" type="submit" value="Back" class="btn mt-2" style="background-color: #1B6065; color: #FFFFFF;">Back</a><br>
                        </form>
                    </div>
                </div>
            </div>
