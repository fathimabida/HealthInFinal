...
@section('content')
    ...
    <div class="container-fluid mt-3">
        <div class="row">
            ...
            <div class="col-3 ml-5">
                <div class="card" style="border-radius:20px;border:none;box-shadow: 0px 0px 6px rgba(0, 0, 0, 0.1)">
                    ...
                    <div class="card-body d-flex flex-column align-items-center position-relative"
                        ...
                        <img src="{{ asset('storage/' . $mahasiswa->foto) }}" class="rounded-circle position-absolute"
                    ...
                    <div class="col-md-12" style="margin-top:120px;">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">
                                ...
                                <a href="?page=profil_kesehatan" class="nav-link">Profil Kesehatan</a>
                            </li>

                            <li class="list-group-item">
                                <span class="fas fa-calendar"></span>
                                <a href="?page=janji_temu" class="nav-link">Janji Temu Saya</a>
                            </li>
                            <li class="list-group-item">
                                <span class="fas fa-list-alt"></span>
                                <a href="#" class="nav-link">List Hasil MCU</a>
                            </li>
                            <li class="list-group-item">
                                <span class="fas fa-list-alt"></span>
                                <a href="{{ route('mahasiswa.konseling') }}" class="nav-link">List Hasil Konseling</a>
                            </li>
                            <li class="list-group-item">
                                <span class="fas fa-list-alt"></span>
                                <a href="{{ route('mahasiswa.listKonselor') }}" class="nav-link">Cari Konselor</a>
                            </li>
            ...
            @if (isset($_GET['page']))
                @if ($_GET['page'] == 'profil')
                    @include('Mahasiswa.profil')
                @elseif ($_GET['page'] == 'janji_temu')
                    @include('Mahasiswa.list_jantem')
                @elseif ($_GET['page'] == 'profil_kesehatan')
                    @include('Mahasiswa.profil_kesehatan')
                @endif
            @else
                <div class="col-md-8">
                    <div class="card p-3"
