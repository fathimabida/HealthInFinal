    ...
    <div class="container mt-5 mb-5">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.update_obat', $obat->id) }}" method="POST"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('nomor_registrasi') is-invalid @enderror"
                            ...
                            value="{{ $obat->nomor_registrasi }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="deskripsi" id="" cols="30" rows="10"
                            class="form-control @error('deskripsi') is-invalid @enderror" placeholder="Deskripsi" required>{{ $obat->deskripsi }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="dosis" id="" cols="30" rows="10"
                            class="form-control @error('dosis') is-invalid @enderror" placeholder="Dosis" required>{{ $obat->dosis }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="aturan_pakai" id="" cols="30" rows="10"
                            class="form-control @error('aturan_pakai') is-invalid @enderror" placeholder="Aturan Pakai" required>{{ $obat->aturan_pakai }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="efek_samping" id="" cols="30" rows="10"
                            class="form-control @error('efek_samping') is-invalid @enderror" placeholder="Efek Samping" required>{{ $obat->efek_samping }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control @error('foto') is-invalid @enderror" id="foto"
                            name="foto" placeholder="Nama Obat" value="{{ $obat->foto }}" 
                            accept="image/*">
