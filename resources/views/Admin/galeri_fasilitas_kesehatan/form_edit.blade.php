    ...
    <div class="container mt-5 mb-5">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.update_galeri_kesehatan', $galeri->id) }}" method="POST"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama_fasilitas') is-invalid @enderror"
                            ...
                            value="{{ $galeri->nama_fasilitas }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="deskripsi" id="" cols="30" rows="10"
                            class="form-control @error('deskripsi') is-invalid @enderror" placeholder="Deskripsi" required>{{ $galeri->deskripsi }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control @error('foto') is-invalid @enderror" id="foto"
                            name="foto" placeholder="Nama Fasilitas Kesehatan" accept="image/*">
