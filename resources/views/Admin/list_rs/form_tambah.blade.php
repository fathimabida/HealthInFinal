    ...
    <div class="container mt-5 mb-5">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3>Data List Rumah Sakit</h3>

            </div>
            <div class="card-body">

                <form action="{{ route('admin.tambah_rs') }}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <div class="mb-3">
                        <label class="form-label">Rumah Sakit</label>
                        <input type="text" class="form-control @error('rumah_sakit') is-invalid @enderror"
                            id="rumah_sakit" name="rumah_sakit" placeholder="Rumah Sakit" value="{{ old('rumah_sakit') }}"
                            required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="alamat" id="" cols="30" rows="10"
                            class="form-control @error('alamat') is-invalid @enderror" placeholder="Alamat Rumah Sakit" required>{{ old('alamat') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('link_maps') is-invalid @enderror" id="link_maps"
                            name="link_maps" placeholder="Link Maps" value="{{ old('link_maps') }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control @error('foto') is-invalid @enderror" id="foto"
                            name="foto" placeholder="Foto Rumah Sakit" value="{{ old('foto') }}" required
                            accept="image/*">
